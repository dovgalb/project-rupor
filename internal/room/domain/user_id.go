...
// UserID — собственный value object идентификатора пользователя в room-домене.
// Параллелен auth.domain.UserID; домены не импортируют друг друга (см. 03-decisions.md §D-08).
