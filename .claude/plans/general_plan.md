...
## Фаза 3.6 — доработки фронта
- [ ] вместо hex первых 6 символов добавить отображение username
- [ ] юзеры должны отображаться в комнате, в которой они находятся сейчас, вместо общих участников комнаты в боковом меню
- [ ] сообщения владельца аккаунта должны отображаться справа в чате, а остальные слева
